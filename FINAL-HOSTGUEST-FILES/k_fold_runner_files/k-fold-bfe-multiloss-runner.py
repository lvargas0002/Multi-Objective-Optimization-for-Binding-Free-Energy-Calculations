...
for k in range(K):
    ...
    with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_bfe_K%d_W_n.pkl' % k, 'wb') as f:
...
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_BFE_MultiLoss_K%d_fold_hists.pkl' % K, 'wb') as file:
    pickle.dump(hists, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_BFE_MultiLoss_K%d_fold_test.pkl' % K, 'wb') as file:
    pickle.dump(test_loss, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_BFE_MultiLoss_K%d_fold_train_pred.pkl' % K, 'wb') as file:
    pickle.dump(predicts_train, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_BFE_MultiLoss_K%d_fold_test_pred.pkl' % K, 'wb') as file:
    pickle.dump(predicts_test, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_BFE_MultiLoss_K%d_fold_y_test.pkl' % K, 'wb') as file:
    pickle.dump(y_tests, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_BFE_MultiLoss_K%d_fold_y_diff.pkl' % K, 'wb') as file:
