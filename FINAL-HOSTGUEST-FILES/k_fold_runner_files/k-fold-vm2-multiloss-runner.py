...
X_folds= pickle.load(open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/X_folds_LT_4.pkl', 'rb'))
y_folds = pickle.load(open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/y_folds_LT_4.pkl', 'rb'))
...
for k in range(K):
    ...
    mae.append(y_difference)
    predicts_test.append(m.predict(x_converted, batch_size=len(X_test)))
    

with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_VM2_K%d_fold_hists.pkl' % K, 'wb') as file:
    pickle.dump(hists, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_VM2_K%d_fold_test.pkl' % K, 'wb') as file:
    pickle.dump(test_loss, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_VM2_K%d_fold_train_pred.pkl' % K, 'wb') as file:
    pickle.dump(predicts_train, file)
with open('/home/lthoma21/BFE-Loss-Function/FINAL-HOSTGUEST-FILES/Datasets/PGCN_VM2_K%d_fold_test_pred.pkl' % K, 'wb') as file:
